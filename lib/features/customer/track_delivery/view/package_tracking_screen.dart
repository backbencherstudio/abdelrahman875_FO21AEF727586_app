...
class PackageTrackingScreen extends ConsumerWidget {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                              ...
                              decoration: InputDecoration(
                                ...
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.zero,
                                    borderSide: BorderSide(color: AppColors.containerColor7)
                                ),
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Image.asset(AppIcons.whiteRoute,height: 24.h,width: 24.h,),
                            ),
                          )
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          Icon(Icons.search,size: 24.h,color: AppColors.grayText),
                          SizedBox(width: 8.w,),
                          Text('Résultats',style: style.bodyLarge?.copyWith(
                            color: AppColors.blackText,
                            fontWeight: FontWeight.w400,
                            fontSize: 15.sp,
                          ),)
